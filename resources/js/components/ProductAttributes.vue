<template>
    <div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="parent">Selecione um atributo <span class="m-l-5 text-danger"> *</span></label>
        ...
        <div class="tile" v-if="attributeSelected">
            <h3 class="tile-title">Adicionar atributos a um produto</h3>
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="values">Selecione um valor <span class="m-l-5 text-danger"> *</span></label>
            ...
            <div class="row" v-if="valueSelected">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <small class="text-danger">Esse preço vai ser adicionado o preço principal no frontend.</small>
                    </div>
                </div>
                <div class="col-md-12">
        ...
        <div class="tile">
            <h3 class="tile-title">Atributos do produto</h3>
            <div class="tile-body">
    ...
    methods: {
        ...
        addProductAttribute() {
            if (this.currentQty === null || this.currentPrice === null) {
                this.$swal("Erro, alguns valores estão faltando.", {
                    icon: "error",
                });
            } else {
                let _this = this;
                ...
                if (willDelete) {
                    ...
                    axios.post('/admin/products/attributes/delete', {
                        ...
                        if (response.data.status === 'success') {
                            _this.$swal("Successo! Atributo do produto excluído!", {
                                icon: "success",
                            });
                            this.loadProductAttributes(this.productid);
                        } else {
                            _this.$swal("O seu atributo de produto não foi excluído!");
                        }
                    }).catch(function (error) {
                        console.log(error);
                    });
                } else {
                    this.$swal("Ação cancelada!");
                }
            });
