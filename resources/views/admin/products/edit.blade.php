                ...
                <div class="tab-pane active" id="general">
                    <div class="tile">
                        <form action="{{ route('admin.products.update') }}" method="POST" role="form">
                            @csrf
                            <h3 class="tile-title">Informações sobre os Produtos</h3>
                            <hr>
                            <div class="tile-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label" for="sale_price">Preço Especial</label>
                                            <input
                                                class="form-control"
                                                type="text"
                                                placeholder="Insira o preço especial do produto"
                                                id="sale_price"
                                                name="sale_price"
                            ...
                            <div class="tile-footer">
                                <div class="row d-print-none mt-2">
                                    <div class="col-12 text-right">
                                        <button class="btn btn-success" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Atualizar Produto</button>
                                        <a class="btn btn-danger" href="{{ route('admin.products.index') }}"><i class="fa fa-fw fa-lg fa-arrow-left"></i>Voltar</a>
                                    </div>
                                </div>
                            </div>
                        </form>
                                ...
                                <div class="row">
                                    @foreach($product->images as $image)
                                        <div class="col-md-3">
                                            <div class="card">
                                                <div class="card-body">
                                                    <img src="{{ $image->full }}" id="brandLogo" class="img-fluid" alt="img">
    ...
    <script>
        ...
        $( document ).ready(function() {
            ...
            myDropzone.on("queuecomplete", function (file) {
                ...
                showNotification('Completo', 'Todas as imagens carregadas com sucesso', 'success', 'fa-check');
            });
