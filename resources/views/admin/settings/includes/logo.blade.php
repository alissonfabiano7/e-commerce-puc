<div class="tile">
    <form action="{{ route('admin.settings.update') }}" method="POST" role="form" enctype="multipart/form-data">
        @csrf
        <h3 class="tile-title">Logomarca</h3>
        <hr>
        <div class="tile-body">
            <div class="row">
                <div class="col-3">
            ...
            <div class="row mt-4">
                <div class="col-3">
                    @if (config('settings.site_favicon') != null)
                        <img src="{{ config('settings.site_favicon') }}" id="faviconImg" style="width: 80px; height: auto;">
                    @else
                ...
                <div class="col-9">
                    <div class="form-group">
                        <label class="control-label">Favicon do Site</label>
