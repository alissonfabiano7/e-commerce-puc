        ...
        <div class="col-md-3">
            <div class="tile p-0">
                <ul class="nav flex-column nav-tabs user-tabs">
                    ...
                    <li class="nav-item"><a class="nav-link" href="#footer-seo" data-toggle="tab">Rodapé</a></li>
                    <li class="nav-item"><a class="nav-link" href="#social-links" data-toggle="tab">Redes Sociais</a></li>
                </ul>
            </div>
        </div>
        <div class="col-md-9">
